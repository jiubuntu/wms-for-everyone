...
export function usePendingCompanies(keyword: string, page: number, limit = 10) {
  return useQuery({
    queryKey: ["companies", "pending", keyword, page, limit],
    queryFn: () => getPendingCompanies(keyword, page, limit),
  })
}
